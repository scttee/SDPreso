...
export default function Slides() {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      if (!present && e.key.toLowerCase() === 'o') setOverview((v) => !v);
